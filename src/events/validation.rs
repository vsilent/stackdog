...
use crate::events::security::{NetworkEvent, AlertEvent};
...
impl ValidationResult {
    ...
    pub fn is_invalid(&self) -> bool {
        matches!(self, ValidationResult::Invalid(_) | ValidationResult::Error(_))
    }
}
...
mod tests {
    ...
    use crate::events::security::{AlertType, AlertSeverity};
    use chrono::Utc;
